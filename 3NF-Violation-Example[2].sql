...
--make d_id as primary key
ALTER TABLE department MODIFY d_id NUMBER PRIMARY KEY;
--INSERT INTO department VALUES(104,'IoT','KL Rao');    --Just for checking

--remove columns from student table
ALTER TABLE students DROP(d_name,d_location);
SELECT *FROM students;

--make d_id as foreign key in students table
