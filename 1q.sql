...
SELECT (MAX(age)-MIN(age)) FROM student WHERE college='ACET' AND branch='IoT';
SELECT MIN(age) FROM student WHERE college='ACET' AND branch='IoT';
SELECT COUNT(*) FROM student WHERE college='ACOE' AND gender='Male';
SELECT gender,college,branch,COUNT(*) FROM student WHERE college='ACET' AND branch='IoT' GROUP BY gender,college,branch ;
SELECT MIN(age) FROM student WHERE college='ACOE';

SELECT COUNT(*) FROM student WHERE date_of_admission BETWEEN TO_DATE('2023-07-01','YYYY-MM-DD') AND TO_DATE('2023-12-31','YYYY-MM-DD');
SELECT MAX(date_of_admission) FROM student WHERE college='ACOE' AND branch='CSE';

SELECT id,fee FROM student ORDER BY fee DESC NULLS LAST;
SELECT SUM(fee) FROM student WHERE college='ACOE' ;
SELECT AVG(fee) FROM student WHERE college='ACET' AND branch='CSE';
SELECT MAX(age) FROM student WHERE college='ACET' AND branch='IoT';
SELECT name,branch FROM student WHERE age=25 AND college='ACET';
SELECT college,COUNT(*) FROM student;
SELECT COUNT(*) FROM student GROUP BY college;
SELECT COUNT(*) FROM student WHERE college='AEC';
SELECT DISTINCT branch FROM student;
SELECT name FROM student WHERE college='ACET' AND branch='IT';
SELECT COUNT(*) FROM student WHERE college='ACET' AND branch='DS';
SELECT college,branch FROM students GROUP BY college,branch;
SELECT COUNT(*) FROM student WHERE branch='MECH';
SELECT COUNT(*) FROM student WHERE college='ACOE' AND branch='CSE';
SELECT gender,COUNT(*) FROM student GROUP BY gender;
SELECT name FROM student WHERE age AND email IS NULL;
